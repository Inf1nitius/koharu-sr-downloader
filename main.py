...
icon = 'https://raw.githubusercontent.com/Nayuta-Kani/SAOIF-Skill-Records-Database/master/srimages/sr_icon_l_60'
...
for id in ids:
    while len(id.strip()) < 5:
        id = f'0{id.strip()}'
    urllib.request.urlretrieve(f'{icon}{id}.png', f'sr_icon_l_60{id}.png')
